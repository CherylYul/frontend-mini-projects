...
export default function Example() {
    return (
        <div className="example-text indent">
            <p className="bold">How I stay committed to learning</p>
            ...
            <p className="bold">How I got started</p>
            <p>I started simple and gradually grew my learning journal site. I would take notes about what 
                I was learning. After each learning session, I'd use my notes to not only reflect on what 
                I learned but also write short summaries of what I learned using my own words.</p>
