export default [
    {
        ...
        description: "A seaside hotspot known amongst  locals for its delicious coffee.  While an old warehouse, surrounded by car dealerships, is not the obvious place for a coffee shop - Summertown’s laid-back ambience and vintage décor makes it feel as though you’re simply stopping by your mates place for a cuppa.",
    ...
    },
    {
        id: 2,
        title: "COFFYLOSOPHY",
        description: "An award-winning café serving up some of the best coffee Adelaide has to offer. Rhe intimate atmosphere of Coffylosphy paired with its friendly baristas makes for a welcoming space to enjoy your morning, or afternoon, cup of joe.",
    ...
    },
    {
        id: 3,
        title: "PETER RABBIT",
        description: "The café boasting lush gardens filled with lemon and avocado trees, pair your coffee with something sweet thanks to the daily pastry selection baked in-house, or linger a little longer and experience one of the best breakfasts Adelaide has to offer.",
    ...
    },
    {
        id: 4,
        title: "BLOOM",
        description: "Bloom Café is one of the most aesthetically pleasing spots for a sip in town. The baristas at Bloom are serving up locally roasted coffee from 1645 Coffee Roasters, that pairs perfectly with a house-made pastry. Dishes are seasonally-inspired and full of locally-sourced ingredients cooked over hot coals.",
        coverImg: "bloom.png",
        stats: {
            rating: 4.7,
            reviewCount: 133,
